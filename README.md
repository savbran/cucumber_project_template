...
This repository contains a Maven project created in Eclipse IDE, used to setup a development environmen with:
- Java
- Maven
- Junit / Gherkin / Cucumber

The project implements all the steps contained in the following intallation procedure.

#### Procedure to install and configure the develpment environment from scratch on your PC:

- **Install the following software**
  1. **[Eclipse for java](https://www.eclipse.org/downloads/packages/release/2018-09/r/eclipse-ide-java-developers "https://www.eclipse.org/downloads/packages/release/2018-09/r/eclipse-ide-java-developers")** - Cross-plattform and cross-language IDE with powerful tools.
  2. [M2Eclipse plugin](https://www.eclipse.org/m2e/ "www.eclipse.org/m2e") - M2Eclipse plugin provides integration for Apache Maven into the Eclipse IDE. To install it into Eclipse don't use the Marketplace but install a new software (Eclipse> Help> Install New Software...) using this site: http://download.eclipse.org/technology/m2e/releases/
  3. [Cucumber Plugin](https://cucumber.github.io/cucumber-eclipse/ "https://cucumber.github.io/cucumber-eclipse/") - Official Eclipse plugin to use Cucumber. Cucumber is a tool that supports Behaviour-Driven Development (BDD). To install Cucumber in eclipse, don't use the Marketplace but install it as new software (Eclipse> Help> Install New Software...) using this site: http://cucumber.github.io/cucumber-eclipse/update-site/
